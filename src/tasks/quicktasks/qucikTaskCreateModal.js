...
//         const res = await Axios.post(apiUrl+"/api/user/responsible",{
...
//   { headers:
//     {"Content-Type":"multipart-formData","auth-token": token },onUploadProgress:ProgressEvent=>{
...
//     <Modal.Header>
//       <h3 style={{  fontWeight: "bold", color: "#ff6600"  }}>Create new observation</h3>
//     </Modal.Header>
//     <Modal.Body>
//         <div>
//           <Row>
//             <Col>
//             <h4>Description<b style={{color:"red"}}>*</b></h4>
//               <textarea
//                 style={{ width: "100%" }}
//                 type="text"
//                 name="apraksts"
...
//           <Row>
//             <Col>
//             <h4>Departament<b style={{color:"red"}}>*</b></h4>
//             <CustomDropdown
...
//             </Col>
//             <Col>
//               <h4>Observation<b style={{color:"red"}}>*</b></h4>
...
//                     checked={safetyCategory==="Unsafe environment"? true: false || ""}
//                     onChange={() => setSafetyCategory(safetyCategory==="Unsafe environment"?"":"Unsafe environment")}
//                     color="green"
//                   />
//                 </Form.Group>
//                 <Form.Group controlId="formBasicCheckbox">
...
//                     type="checkbox"
//                     label="Unsafe action"
//                     checked={safetyCategory ==="Unsafe action"? true: false ||"" }
//                     onChange={() => setSafetyCategory(safetyCategory==="Unsafe action"?"":"Unsafe action")}
//                   />
//                 </Form.Group>
//                 <Form.Group controlId="formBasicCheckbox">
//                   <Form.Check
...
//                     onChange={() => setSafetyCategory(safetyCategory==="Accident"?"":"Accident")}
//                   />
//                 </Form.Group>
//               </Form>
//             </Col>
...
//           <b style={{color:"red"}}>*</b><h5>Mandatory fields</h5>
//         </Row>
//       </Col>
...
//         <Button floated="left" variant="danger" size="sm" onClick={() => createModal()}>
//           Exit
//         </Button>
//         <Button
//         size="sm"
