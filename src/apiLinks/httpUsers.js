//login
export const loginApi = "/user/api/auth/login";
export const loginConfimrApi = "/user/api/auth/confirm";
...
export const userChangePasswordApi = "/user/api/user/password/change";
export const userResetPasswordApi = "/user/api/user/password/reset";
